...
import './Ieltsvisa.scss'


const Ieltsvisa = () => {
	return (<>
    <section class="c-section">
    <h2 class="c-section__title" ><span><div style={{fontSize: "57px"}}>IELTS, Visa & Immigration</div></span></h2>
    <ul class="c-services">
