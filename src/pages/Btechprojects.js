    ...
    return (
        <>
            <div class="head-container">
                <div class="quote">
                    <h1 style={{ fontFamily: "Open Sans", fontSize: "40px" }}>B.Tech & M.Tech Projects- Major/ Minor</h1>
                    <hr />
                    <br />
                    <p style={{ fontFamily: "Open Sans", fontSize: "17px", lineHeight: "35px" }}>Running out if idea for Minor/Major project? We are here to help you out. Idea pitching to completion of project, get support from our team to ace your project.
                    </p>
                </div>
                <div class="svg-image">
            ...
            <div class="course" style={{ marginBottom: "20px" }}>
                <center><div class="cbox">
                    <div class="det"><a href="subjects/jee.html"><img src={Book} />Senior Support</a></div>
                    <div class="det"><a href="subjects/gate.html"><img src={D1} />Higher Grades</a></div>
                    <div class="det"><a href="subjects/jee.html#sample_papers"><img src={Paper} />Acknowledgement</a></div>
                    <div class="det"><a href="subjects/quiz.html"><img src={D1} />Table of Contents</a></div>
                </div>
                </center>
                <div class="cbox">
                    <div class="det"><a href="subjects/computer_courses.html"><img src={Computer} />Abstract</a></div>
                    <div class="det"><a href="subjects/computer_courses.html#data"><img src={Data} />Registered Scopus</a></div>
