...
<br/>
            ...
            <div class="diffSection" id="portfolio_section">
                <center><p style={{ fontSize: "50px", padding: "100px", paddingBottom: "40px" }}>Terms & Conditions</p></center>
                    <p className='content'>
                    <b>Parents and students are requested to read the following terms & conditions. If you do not follow our instructions, then we'll not be responsible for any inconvenience.</b>
                    <br/>
                    <br/>
