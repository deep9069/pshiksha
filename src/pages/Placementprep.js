        ...
        <>
            ...
            <div class="course" style={{ marginBottom: "20px" }}>
                <center><div class="cbox">
                    <div class="det"><a href="subjects/jee.html"><img src={Book} />Expert Guidance</a></div>
                    <div class="det"><a href="subjects/gate.html"><img src={D1} />Tech & Non-tech prep</a></div>
                ...
                <div class="cbox">
                    <div class="det"><a href="subjects/computer_courses.html"><img src={Computer} />Short Notes</a></div>
                    <div class="det"><a href="subjects/computer_courses.html#data"><img src={Data} />Organized cirriculum</a></div>
                    <div class="det"><a href="subjects/computer_courses.html#algo"><img src={Algo} />On time completion</a></div>
